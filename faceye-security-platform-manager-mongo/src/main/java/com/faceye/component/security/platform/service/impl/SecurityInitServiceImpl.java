...
public class SecurityInitServiceImpl implements SecurityInitService {
	...
	private String menus[][] = new String[][] { { "角色管理", "/security/platform/role/home" }, { "用户管理", "/security/platform/user/home" },
			{ "资源管理", "/security/platform/resource/home" }, { "菜单管理", "/security/platform/menu/home" } };
