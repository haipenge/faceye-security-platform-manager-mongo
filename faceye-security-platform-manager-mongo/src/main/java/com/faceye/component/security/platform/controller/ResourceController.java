...
@Scope("prototype")
@RequestMapping("/security/platform/resource")
public class ResourceController extends BaseController<Resource, Long, ResourceService> {
	...
	public String home(HttpServletRequest request, Model model) {
		...
		return "security.platform.resource.manager";
	}
	...
	public String edit(@PathVariable("id") Long id, Model model) {
		...
		return "security.platform.resource.update";
	}
	...
	public String save(Resource entity, RedirectAttributes redirectAttributes) {
		...
		return "redirect:/security/platform/resource/home";
	}
	...
	public String detail(@PathVariable Long id, Model model) {
		...
		return "security.platform.resource.detail";
	}
