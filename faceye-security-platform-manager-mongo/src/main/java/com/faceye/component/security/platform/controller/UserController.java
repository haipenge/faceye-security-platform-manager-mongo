...
@Scope("prototype")
@RequestMapping("/security/platform/user")
public class UserController extends BaseController<User, Long, UserService> {
	...
	public String home(HttpServletRequest request, Model model) {
		...
		return "security.platform.user.manager";
	}
	...
	public String edit(@PathVariable("id") Long id, Model model) {
		...
		return "security.platform.user.update";
	}
	...
	public String save(User entity, RedirectAttributes redirectAttributes) {
		...
		return "redirect:/security/platform/user/home";
	}
	...
	public String detail(@PathVariable Long id, Model model) {
		...
		return "security.platform.user.detail";
	}
	...
	public String perpareAuthRoles(@PathVariable Long id, Model model) {
		...
		return "security.platform.user.perepare.auth";
	}
	...
	@RequestMapping("/init")
	public String init() {
		this.securityInitService.reInit();
		return "default.msg";
	}
