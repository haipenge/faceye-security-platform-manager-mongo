...
<div class="page-head">
	<h2>
		<fmt:message key="security.platform.user.auth.roles"></fmt:message>
	</h2>
</div>
...
<div class="cl-mcont">
	<div class="block-flat">
		<div class="content">
			...
			<form action="<c:url value="/security/platform/menu/authMenus"/>" method="post" role="form" class="form-horizontal">
				<div classs="table-responsive">
					<input type="hidden" name="roleId" value="${role.id}">
					<table class="table table-bordered table-hover">
						<tr>
							<td></td>
							<td><fmt:message key='security.platform.menu.name'></fmt:message></td>
							<td><fmt:message key="security.platform.menu.url"></fmt:message>
						</tr>
