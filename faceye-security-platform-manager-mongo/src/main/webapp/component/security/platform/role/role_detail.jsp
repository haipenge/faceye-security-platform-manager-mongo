...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">
			<fmt:message key="security.platform.role.detail"></fmt:message>
		</div>
	</div>
	<div class="panel-body">
			<fieldset>
					...
					<label class="col-md-4 control-label" for="role">
					  <fmt:message key="security.platform.role.name"></fmt:message>
					 </label>
					<div class="col-md-4">
						${role.name}
					</div>
								...
								<div class="form-group">
					<label class="col-md-4 control-label" for="role">
					  <fmt:message key="security.platform.role.users"></fmt:message>
					 </label>
					<div class="col-md-4">
						${role.users}
					</div>
